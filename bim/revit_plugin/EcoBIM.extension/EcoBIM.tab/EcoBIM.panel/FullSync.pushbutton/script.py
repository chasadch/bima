# -*- coding: utf-8 -*-
"""
Full Sync: Extract U-values, GFA, and material quantities from the active
Revit model and push everything to the EcoBIM backend in one step.
"""
...
print("EcoBIM: Performing full extraction & sync...")
...
try:
    ...
    # Push
    success, msg = helpers.push_to_backend(quantities=quantities, u_values=u_values, gfa=gfa)
    print("\n--- BACKEND SYNC ---")
    if success:
        print("✅ Success! " + msg)
    else:
